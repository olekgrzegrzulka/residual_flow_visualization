...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{Uruchom:} Inicjuje działanie algorytmu. Na krawędziach pojawi się animacja mrowienia ilustrująca przepływ gazu, a w lewym górnym rogu wyświetli się obliczona wartość maksymalnego przepływu.
		\item \textbf{Zatrzymaj:} Zatrzymuje animację i ukrywa wyniki, zachowując strukturę utworzonego grafu do dalszej edycji.
	\end{itemize}
